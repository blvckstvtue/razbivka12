			...
			switch (Function_OnWeaponThink(hPlugin[client], weapon_sequence[client], client, WeaponIndex, ClientVM2[client], OldSequence[client], Sequence))
			{
				case Plugin_Continue :
				{
					...
					if (HasSoundAt[client][Sequence] || StopSounds[client])
					{
						if (!IsFakeClient(client))
						{
							EmitSoundToClient(client, "resource/warning.wav", client, SNDCHAN_WEAPON, SNDLEVEL_NONE, SND_STOPLOOPING, 0.0, 100);
							EmitSoundToClient(client, "resource/warning.wav", client, SNDCHAN_ITEM, SNDLEVEL_NONE, SND_STOPLOOPING, 0.0, 100);
						}
...
stock TE_SetupMuzzleFlash(Float:pos[3], Float:angles[3], Float:Scale, Type)
{
